 ...
 * </p>
 * <ul>
 *   <li>{@link TypeAliasImpl#isAbstract <em>Abstract</em>}</li>
 *   <li>{@link TypeAliasImpl#isVisible <em>Visible</em>}</li>
 *   <li>{@link TypeAliasImpl#getSuperTypes <em>Super Types</em>}</li>
 * </ul>
 *
 * @generated
 */
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Type.class) {
            switch (derivedFeatureID) {
                ...
                case TypesPackage.TYPE_ALIAS__VISIBLE:
                    return TypesPackage.TYPE__VISIBLE;
                case TypesPackage.TYPE_ALIAS__SUPER_TYPES:
                    return TypesPackage.TYPE__SUPER_TYPES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == Type.class) {
            switch (baseFeatureID) {
                ...
                case TypesPackage.TYPE__VISIBLE:
                    return TypesPackage.TYPE_ALIAS__VISIBLE;
                case TypesPackage.TYPE__SUPER_TYPES:
                    return TypesPackage.TYPE_ALIAS__SUPER_TYPES;
                default:
                    return -1;
            }
        }
