 ...
 * </p>
 * <ul>
 *   <li>{@link TypedDeclarationImpl#getType <em>Type</em>}</li>
 *   <li>{@link TypedDeclarationImpl#getTypeSpecifier <em>Type Specifier</em>}</li>
 * </ul>
 *
 * @generated
 */
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == TypedElement.class) {
            switch (derivedFeatureID) {
                ...
                case TypesPackage.TYPED_DECLARATION__TYPE_SPECIFIER:
                    return TypesPackage.TYPED_ELEMENT__TYPE_SPECIFIER;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == TypedElement.class) {
            switch (baseFeatureID) {
                case TypesPackage.TYPED_ELEMENT__TYPE:
                    return TypesPackage.TYPED_DECLARATION__TYPE;
                case TypesPackage.TYPED_ELEMENT__TYPE_SPECIFIER:
                    return TypesPackage.TYPED_DECLARATION__TYPE_SPECIFIER;
                default:
                    return -1;
            }
        }
