 ...
 * </p>
 * <ul>
 *   <li>{@link PackageImpl#getDomainID <em>Domain ID</em>}</li>
 *   <li>{@link PackageImpl#getMember <em>Member</em>}</li>
 *   <li>{@link PackageImpl#getImport <em>Import</em>}</li>
 * </ul>
 *
 * @generated
 */
        ...
        if (baseClass == DomainElement.class) {
            switch (baseFeatureID) {
                case BasePackage.DOMAIN_ELEMENT__DOMAIN_ID:
                    return TypesPackage.PACKAGE__DOMAIN_ID;
                default:
                    return -1;
            }
        }
