 ...
 * </p>
 * <ul>
 *   <li>{@link StateImpl#getLocalReactions <em>Local Reactions</em>}</li>
 *   <li>{@link StateImpl#getScopes <em>Scopes</em>}</li>
 *   <li>{@link StateImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link StateImpl#getName <em>Name</em>}</li>
 *   <li>{@link StateImpl#getParentRegion <em>Parent Region</em>}</li>
 *   <li>{@link StateImpl#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 *   <li>{@link StateImpl#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 *   <li>{@link StateImpl#getRegions <em>Regions</em>}</li>
 *   <li>{@link StateImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link StateImpl#isOrthogonal <em>Orthogonal</em>}</li>
 *   <li>{@link StateImpl#isSimple <em>Simple</em>}</li>
 *   <li>{@link StateImpl#isComposite <em>Composite</em>}</li>
 *   <li>{@link StateImpl#isLeaf <em>Leaf</em>}</li>
 * </ul>
 *
 * @generated
 */
