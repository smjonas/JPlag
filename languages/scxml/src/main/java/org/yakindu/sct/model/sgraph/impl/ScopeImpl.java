 ...
 * </p>
 * <ul>
 *   <li>{@link ScopeImpl#getDeclarations <em>Declarations</em>}</li>
 *   <li>{@link ScopeImpl#getEvents <em>Events</em>}</li>
 *   <li>{@link ScopeImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link ScopeImpl#getReactions <em>Reactions</em>}</li>
 *   <li>{@link ScopeImpl#getMembers <em>Members</em>}</li>
 * </ul>
 *
 * @generated
 */
