 ...
 * </p>
 * <ul>
 *   <li>{@link State#isOrthogonal <em>Orthogonal</em>}</li>
 *   <li>{@link State#isSimple <em>Simple</em>}</li>
 *   <li>{@link State#isComposite <em>Composite</em>}</li>
 *   <li>{@link State#isLeaf <em>Leaf</em>}</li>
 * </ul>
 *
