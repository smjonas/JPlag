 ...
 * </p>
 * <ul>
 *   <li>{@link Vertex#getParentRegion <em>Parent Region</em>}</li>
 *   <li>{@link Vertex#getIncomingTransitions <em>Incoming Transitions</em>}</li>
 *   <li>{@link Vertex#getOutgoingTransitions <em>Outgoing Transitions</em>}</li>
 * </ul>
 *
...
public interface Vertex extends NamedElement {
	 ...
	 * It is bidirectional and its opposite is '{@link Region#getVertices <em>Vertices</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * Sets the value of the '{@link Vertex#getParentRegion <em>Parent Region</em>}' container reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link Transition}.
	 * It is bidirectional and its opposite is '{@link Transition#getTarget <em>Target</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * The list contents are of type {@link Transition}.
	 * It is bidirectional and its opposite is '{@link Transition#getSource <em>Source</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
