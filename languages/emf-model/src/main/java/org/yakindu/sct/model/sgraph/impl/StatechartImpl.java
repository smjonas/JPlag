 ...
 * </p>
 * <ul>
 *   <li>{@link StatechartImpl#getLocalReactions <em>Local Reactions</em>}</li>
 *   <li>{@link StatechartImpl#getScopes <em>Scopes</em>}</li>
 *   <li>{@link StatechartImpl#getNamespace <em>Namespace</em>}</li>
 *   <li>{@link StatechartImpl#getRegions <em>Regions</em>}</li>
 *   <li>{@link StatechartImpl#getName <em>Name</em>}</li>
 *   <li>{@link StatechartImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link StatechartImpl#getDomainID <em>Domain ID</em>}</li>
 *   <li>{@link StatechartImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link StatechartImpl#getAnnotationInfo <em>Annotation Info</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StatechartImpl extends SpecificationElementImpl implements
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == DomainElement.class) {
            switch (derivedFeatureID) {
                case SGraphPackage.STATECHART__DOMAIN_ID:
                    return BasePackage.DOMAIN_ELEMENT__DOMAIN_ID;
                default:
                    return -1;
            }
        }
        if (baseClass == AnnotatableElement.class) {
            switch (derivedFeatureID) {
                case SGraphPackage.STATECHART__ANNOTATIONS:
                    return TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATIONS;
                case SGraphPackage.STATECHART__ANNOTATION_INFO:
                    return TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATION_INFO;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == DomainElement.class) {
            switch (baseFeatureID) {
                case BasePackage.DOMAIN_ELEMENT__DOMAIN_ID:
                    return SGraphPackage.STATECHART__DOMAIN_ID;
                default:
                    return -1;
            }
        }
        if (baseClass == AnnotatableElement.class) {
            switch (baseFeatureID) {
                case TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATIONS:
                    return SGraphPackage.STATECHART__ANNOTATIONS;
                case TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATION_INFO:
                    return SGraphPackage.STATECHART__ANNOTATION_INFO;
                default:
                    return -1;
            }
        }
