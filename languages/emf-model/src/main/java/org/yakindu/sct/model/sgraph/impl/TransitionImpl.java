 ...
 * </p>
 * <ul>
 *   <li>{@link TransitionImpl#getTrigger <em>Trigger</em>}</li>
 *   <li>{@link TransitionImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link TransitionImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link TransitionImpl#getDocumentation <em>Documentation</em>}</li>
 *   <li>{@link TransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link TransitionImpl#getSource <em>Source</em>}</li>
 * </ul>
 *
 * @generated
 */
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == Reaction.class) {
            switch (derivedFeatureID) {
                case SGraphPackage.TRANSITION__TRIGGER:
                    return SGraphPackage.REACTION__TRIGGER;
                case SGraphPackage.TRANSITION__EFFECT:
                    return SGraphPackage.REACTION__EFFECT;
                case SGraphPackage.TRANSITION__PROPERTIES:
                    return SGraphPackage.REACTION__PROPERTIES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == Reaction.class) {
            switch (baseFeatureID) {
                case SGraphPackage.REACTION__TRIGGER:
                    return SGraphPackage.TRANSITION__TRIGGER;
                case SGraphPackage.REACTION__EFFECT:
                    return SGraphPackage.TRANSITION__EFFECT;
                case SGraphPackage.REACTION__PROPERTIES:
                    return SGraphPackage.TRANSITION__PROPERTIES;
                default:
                    return -1;
            }
        }
        if (baseClass == DocumentedElement.class) {
            switch (baseFeatureID) {
                case BasePackage.DOCUMENTED_ELEMENT__DOCUMENTATION:
                    return SGraphPackage.TRANSITION__DOCUMENTATION;
                default:
                    return -1;
            }
        }
