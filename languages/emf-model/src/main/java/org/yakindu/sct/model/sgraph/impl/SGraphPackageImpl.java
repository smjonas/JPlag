...
public class SGraphPackageImpl extends EPackageImpl implements SGraphPackage {
    ...
    public static SGraphPackage init() {
        if (isInited) return (SGraphPackage) Registry.INSTANCE.getEPackage(SGraphPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredSGraphPackage = Registry.INSTANCE.get(eNS_URI);
        ...
        Registry.INSTANCE.put(SGraphPackage.eNS_URI, theSGraphPackage);
