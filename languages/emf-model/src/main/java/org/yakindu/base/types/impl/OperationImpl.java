 ...
 * </p>
 * <ul>
 *   <li>{@link OperationImpl#getTypeParameters <em>Type Parameters</em>}</li>
 *   <li>{@link OperationImpl#getParameters <em>Parameters</em>}</li>
 *   <li>{@link OperationImpl#isVariadic <em>Variadic</em>}</li>
 * </ul>
 *
 * @generated
 */
        ...
        if (baseClass == GenericElement.class) {
            switch (baseFeatureID) {
                case TypesPackage.GENERIC_ELEMENT__TYPE_PARAMETERS:
                    return TypesPackage.OPERATION__TYPE_PARAMETERS;
                default:
                    return -1;
            }
        }
