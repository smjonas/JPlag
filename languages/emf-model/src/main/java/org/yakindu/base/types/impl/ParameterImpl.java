 ...
 * </p>
 * <ul>
 *   <li>{@link ParameterImpl#getType <em>Type</em>}</li>
 *   <li>{@link ParameterImpl#getTypeSpecifier <em>Type Specifier</em>}</li>
 *   <li>{@link ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link ParameterImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link ParameterImpl#getAnnotationInfo <em>Annotation Info</em>}</li>
 *   <li>{@link ParameterImpl#getOwningOperation <em>Owning Operation</em>}</li>
 *   <li>{@link ParameterImpl#isVarArgs <em>Var Args</em>}</li>
 *   <li>{@link ParameterImpl#isOptional <em>Optional</em>}</li>
 * </ul>
 *
 * @generated
 */
        ...
        if (baseClass == NamedElement.class) {
            switch (baseFeatureID) {
                case BasePackage.NAMED_ELEMENT__NAME:
                    return TypesPackage.PARAMETER__NAME;
                default:
                    return -1;
            }
        }
        if (baseClass == AnnotatableElement.class) {
            switch (baseFeatureID) {
                case TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATIONS:
                    return TypesPackage.PARAMETER__ANNOTATIONS;
                case TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATION_INFO:
                    return TypesPackage.PARAMETER__ANNOTATION_INFO;
                default:
                    return -1;
            }
        }
