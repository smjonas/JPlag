 ...
 * </p>
 * <ul>
 *   <li>{@link ComplexTypeImpl#getTypeParameters <em>Type Parameters</em>}</li>
 *   <li>{@link ComplexTypeImpl#getFeatures <em>Features</em>}</li>
 * </ul>
 *
 * @generated
 */
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        if (baseClass == GenericElement.class) {
            switch (derivedFeatureID) {
                case TypesPackage.COMPLEX_TYPE__TYPE_PARAMETERS:
                    return TypesPackage.GENERIC_ELEMENT__TYPE_PARAMETERS;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == GenericElement.class) {
            switch (baseFeatureID) {
                case TypesPackage.GENERIC_ELEMENT__TYPE_PARAMETERS:
                    return TypesPackage.COMPLEX_TYPE__TYPE_PARAMETERS;
                default:
                    return -1;
            }
        }
