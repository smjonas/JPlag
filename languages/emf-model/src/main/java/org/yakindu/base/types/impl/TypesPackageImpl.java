...
public class TypesPackageImpl extends EPackageImpl implements TypesPackage {
     ...
     * {@link Registry EPackage.Registry} by the
    ...
    public static TypesPackage init() {
        if (isInited) return (TypesPackage) Registry.INSTANCE.getEPackage(TypesPackage.eNS_URI);

        // Obtain or create and register package
        Object registeredTypesPackage = Registry.INSTANCE.get(eNS_URI);
        ...
        Registry.INSTANCE.put(TypesPackage.eNS_URI, theTypesPackage);
    ...
    public void initializePackageContents() {
        ...
        BasePackage theBasePackage = (BasePackage) Registry.INSTANCE.getEPackage(BasePackage.eNS_URI);
