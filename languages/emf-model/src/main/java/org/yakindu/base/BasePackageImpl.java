...
public class BasePackageImpl extends EPackageImpl implements BasePackage {
    ...
    public static BasePackage init() {
        if (isInited) return (BasePackage) Registry.INSTANCE.getEPackage(BasePackage.eNS_URI);

        // Obtain or create and register package
        Object registeredBasePackage = Registry.INSTANCE.get(eNS_URI);
        ...
        Registry.INSTANCE.put(BasePackage.eNS_URI, theBasePackage);
