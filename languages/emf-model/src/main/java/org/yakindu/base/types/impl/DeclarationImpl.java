 ...
 * </p>
 * <ul>
 *   <li>{@link DeclarationImpl#getAnnotations <em>Annotations</em>}</li>
 *   <li>{@link DeclarationImpl#getAnnotationInfo <em>Annotation Info</em>}</li>
 *   <li>{@link DeclarationImpl#getMetaFeatures <em>Meta Features</em>}</li>
 *   <li>{@link DeclarationImpl#isStatic <em>Static</em>}</li>
 *   <li>{@link DeclarationImpl#getId <em>Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DeclarationImpl extends NamedElementImpl implements Declaration {
    ...
    public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
        ...
        if (baseClass == MetaComposite.class) {
            switch (derivedFeatureID) {
                case TypesPackage.DECLARATION__META_FEATURES:
                    return TypesPackage.META_COMPOSITE__META_FEATURES;
                default:
                    return -1;
            }
        }
        ...
        if (baseClass == AnnotatableElement.class) {
            switch (baseFeatureID) {
                case TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATIONS:
                    return TypesPackage.DECLARATION__ANNOTATIONS;
                case TypesPackage.ANNOTATABLE_ELEMENT__ANNOTATION_INFO:
                    return TypesPackage.DECLARATION__ANNOTATION_INFO;
                default:
                    return -1;
            }
        }
        if (baseClass == MetaComposite.class) {
            switch (baseFeatureID) {
                case TypesPackage.META_COMPOSITE__META_FEATURES:
                    return TypesPackage.DECLARATION__META_FEATURES;
                default:
                    return -1;
            }
        }
