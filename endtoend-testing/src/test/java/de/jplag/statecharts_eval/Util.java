...
public class Util {
    ...
    private static final String ORIGINAL_SUBMISSION_DIR = "src/test/resources/statecharts/%d_assignments/original/";
    protected static final String BASE_SUBMISSION_DIR = "src/test/resources/statecharts/%d_assignments/";
    ...
    public static JPlagResult runJPlag(int year, String lang, String submissionFolder, int minTokenMatch) throws ExitException {
        ...
        JPlagOptions jplagOptions = new JPlagOptions(language, Set.of(submissionDir), Set.of()).withMinimumTokenMatch(minTokenMatch);
